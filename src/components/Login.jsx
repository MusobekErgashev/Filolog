    ...
    <div className='flex flex-col h-full anim-fade-in'>
      <form action="" onSubmit={formSubmit} className='flex flex-col gap-5'>
        <div className="flex flex-col gap-1.5">
          ...
          <input
            required
            className="w-full bg-gray-50 outline-none px-4 py-3.5 text-[14px] text-[#0F172B] rounded-2xl border border-gray-200 focus:border-[#006EDD] focus:ring-4 focus:ring-[#006fdd10] transition-all duration-300 placeholder:text-gray-400"
            id="email"
            type="email"
        ...
        <p className='text-[#F84800] text-[13px] text-center font-medium opacity-0 transition-opacity duration-300'>Email yoki parol xato!</p>
