  ...
  return (
    <div className='flex flex-col h-full anim-fade-in'>
      ...
      <div className="mt-6 flex flex-col gap-4">
        ...
        <button className="w-full py-3.5 px-4 border border-gray-200 rounded-2xl flex items-center justify-center gap-3 hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 font-semibold text-gray-700 active:scale-[0.98]">
